/*
 How to use:
	1. Call a new instance of this class with one of the constructors. (Menu myMenu = new Menu("Start Menu", optionCategoryArray);)
	...
	2. Declare an int array and assign it with the return value of the Run() method. (int[] input = myMenu.Run();)
